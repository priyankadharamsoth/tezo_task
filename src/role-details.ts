...
export function getDetails(roleId : number,deptId: number,locationId: number) {
...
function detailsHeaderSection(roleId: number,deptId: number,locationId: number){
...
function filterEmployeesSection(roleId: number) {
