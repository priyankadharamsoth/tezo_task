import { employees, departments, locations } from "./models.js";
export function getDetails(roleId, deptId, locationId) {
...
function filterEmployeesSection(roleId) {
    ...
    if (employeesByRole.length == 0) {
        ...
        employeesByRole.forEach(emp => {
            var _a, _b;
            const empDept = ((_a = departments.find(dept => dept.id === emp.deptId)) === null || _a === void 0 ? void 0 : _a.department) || 'N/A';
            const empLoc = ((_b = locations.find(loc => loc.id === emp.locationId)) === null || _b === void 0 ? void 0 : _b.location) || 'N/A';
